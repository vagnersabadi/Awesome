...
|Getting Started Guide|[Ionic 3](http://ionicframework.com/docs/getting-started/)||
|Ionic Native|[Ionic 3](https://github.com/ionic-team/ionic-native/)||
|Showcase|[Ionic 3](http://showcase.ionicframework.com/)||
|Learn Ionic|[Ionic 3](http://learn.ionicframework.com/)||
|Ionic on CodePen|[Ionic 3](http://codepen.io/ionic/)||
...
|Ionic View|[Ionic 3](http://apps.ionic.io/view-app)|Test and share your ionic app on iPhone without needing a Mac||
|Ionic Framework generator|[Ionic 3](https://github.com/diegonetto/generator-ionic)|Yeoman generator for Ionic||
|Ionic box|[Ionic 3](https://github.com/ionic-team/ionic-box)|Vagrant box for ionic||
...
|Creating a Realtime Image Sharing App|[Ionic 3](http://www.htmlxprs.com/post/6/creating-a-realtime-image-sharing-app-with-ionic-and-socketio-tutorial)||
|Custom URL Schemes|[Ionic 3](http://mcgivery.com/using-custom-url-schemes-ionic-framework-app/)||
|Deploy Ionic Framework App With Pre-Filled SQLite DB|[Ionic 3](https://blog.nraboy.com/2015/01/deploy-ionic-framework-app-pre-filled-sqlite-db/)||
|How to play audio|[Ionic 3](https://www.thepolyglotdeveloper.com/2014/11/playing-audio-android-ios-ionicframework-app/)||
|How we built our app in 2 weeks using Ionic Framework|[Ionic 3](https://www.airport-parking-shop.co.uk/blog/built-app-2-weeks-using-ionic-framework/)||
|Internationalization of an Ionic App: Multilanguage Support|[Ionic 3](http://mcgivery.com/internationalization-of-an-ionic-app-multilanguage-support/)||
|Let Your Ionic App Move With Move.js|[Ionic 3](https://www.youtube.com/watch?v=4UbAC8PEQHY)||
|Making a Lock Pattern Login|[Ionic 3](http://devdactic.com/lock-pattern-login-ionic/)||
|Making a Signature Drawpad|[Ionic 3](https://www.youtube.com/watch?v=KpBEyvGA0OE)||
|Mastering the Ionic Framework: Learn to Build & Deploy Native Speed HTML5 Based Apps|[Ionic 3](https://thinkster.io/ionic-framework-tutorial/)||
|Preload images in Ionic using $ImageCacheFactory|[Ionic 3](http://mcgivery.com/preload-images-ionic/?utm_content=bufferf9a09&utm_medium=social&utm_source=twitter.com&utm_campaign=buffer)||
|Production ready apps with Ionic Framework|[Ionic 3](https://www.airpair.com/ionic-framework/posts/production-ready-apps-with-ionic-framework)||
|Push Notifications Sample App with Ionic and ngCordova|[Ionic 3](http://devgirl.org/2014/12/16/push-notifications-sample-app-with-ionic-and-ngcordova/)||
|Structure of an Ionic App|[Ionic 3](http://mcgivery.com/structure-of-an-ionic-app/)||
|Sync Data Using PouchDB In Your Ionic Framework App|[Ionic 3](http://devgirl.org/2014/12/30/sync-data-using-pouchdb-in-your-ionic-framework-app/)||
|Upload Files To A Remote Server|[Ionic 3](https://www.thepolyglotdeveloper.com/2015/01/upload-files-remote-server-using-ionic-framework/)||
|Using Factories and Web Services|[Ionic 3](http://mcgivery.com/ionic-using-factories-and-web-services-for-dynamic-data/)||
|Using Typescript with Ionic|[Ionic 3](https://weblogs.asp.net/soever/ionictypescript)||
|Ionic Framework Tutorial form ccoenraets|[Ionic 3](http://ccoenraets.github.io/ionic-tutorial/)||
|Installing Ionic|[Ionic 3](http://ccoenraets.github.io/ionic-tutorial/install-ionic.html)||
|Starting the Node Server|[Ionic 3](http://ccoenraets.github.io/ionic-tutorial/start-node-server.html)||
|Creating an Ionic Application|[Ionic 3](http://ccoenraets.github.io/ionic-tutorial/create-ionic-application.html)||
|Creating the Session Service|[Ionic 3](http://ccoenraets.github.io/ionic-tutorial/create-angular-service.html)||
|Creating the Session Controllers|[Ionic 3](http://ccoenraets.github.io/ionic-tutorial/create-angular-controller.html)||
|Creating Templates|[Ionic 3](http://ccoenraets.github.io/ionic-tutorial/create-ionic-template.html)||
...
|A Simple Guide to Navigation in Ionic 2|[Ionic 3](http://www.joshmorony.com/a-simple-guide-to-navigation-in-ionic-2/)||
|10 Minutes with Ionic 2: Adding Pages and Navigation|[Ionic 3](http://blog.ionic.io/10-minutes-with-ionic-2-adding-pages-and-navigation/)||
|10 Minutes with Ionic 2: Calling an API|[Ionic 3](http://blog.ionic.io/10-minutes-with-ionic-2-calling-an-api/)||
|How To Update Your Application Project and CLI|[Ionic 3](http://www.gajotres.net/ionic-2-how-to-update-your-application-project-and-cli/)||
|How to Create a Data Model in Ionic 2|[Ionic 3](http://www.joshmorony.com/how-to-create-a-data-model-in-ionic-2/)||
...
|Ionic 2 and Auth0|[Ionic 3](http://blog.ionic.io/ionic-2-and-auth0/)||
...
|Make HTTP Requests In An Ionic 2 Android And iOS App|[Ionic 3](https://www.thepolyglotdeveloper.com/2016/01/make-http-requests-in-an-ionic-2-android-and-ios-app/)||
|Making REST HTTP Requests Like a Pro|[Ionic 3](http://www.gajotres.net/ionic-2-making-rest-http-requests-like-a-pro/)||
|Parse REST API tutorial|[Ionic 3](http://www.htmlxprs.com/post/12/tutorial-on-using-parse-rest-api-and-ionic-framework-together) - Parse tutorial||
|Parse Sample App|[Ionic 3](https://github.com/giorgiofellipe/ionic-angular-parse-boilerplate) - using [angular-parse lib|[Ionic 3](https://github.com/jimrhoskins/angular-parse)||
|Posting data from Ionic 2 app to a PHP server|[Ionic 3](http://www.nikola-breznjak.com/blog/ionic2/posting-data-from-ionic-2-app/)||
...
|Ionic 2 Push Notification|[Ionic 3](https://github.com/aggarwalankush/ionic2-push-base)||
|Ionic 2 Weather app|[Ionic 3](https://github.com/aggarwalankush/ionic2-mosum)||
|Ionic Chat application|[Ionic 3](https://github.com/melvin0008/ionic-socketio-chat-client/)|Chat application made using ionic and socketio||
|Ionic Conference App based on Lanyrd API|[Ionic 3](https://github.com/ionic2blueprints/conference-app)||
|Ionic Conference App|[Ionic 3](https://github.com/ionic-team/ionic-conference-app)||
|Ionic Ecommerce App|[Ionic 3](https://github.com/ionic2blueprints/ionic2-marketcloud)||
|Ionic Firebase Chat App|[Ionic 3](https://github.com/ionic2blueprints/firebase-chat)||
|Ionic Hacker News|[Ionic 3](https://github.com/ionic-team/front-page)||
|Ionic Media Player|[Ionic 3](https://github.com/ionic2blueprints/media-player)||
|Ionic Social App|[Ionic 3](https://github.com/ionic2blueprints/social-app)||
|Ionic Stock Tracking App|[Ionic 3](https://github.com/ionic2blueprints/ionic2-stockmarket)||
|Ionic Weather App|[Ionic 3](https://github.com/ionic-team/ionic-weather)||
|Ionic Wordpress Client|[Ionic 3](https://github.com/ionic2blueprints/ionic2-wp-client)||
|IonicRealty|[Ionic 3](https://github.com/ccoenraets/ionic2-realty)||
...
|Ionic Framework By Example|[Ionic 3](http://www.amazon.it/Ionic-Framework-Example-Sani-Yusuf-ebook/dp/B01AJST0W6/ref=sr_1_1?ie=UTF8&qid=1458563315&sr=8-1&keywords=Ionic+Framework+By+Example)||
...
| Description| Ionic 3 | Ionic 4 |
| :- | :- | :- |
|10 Minutes with Ionic 2: Using the Camera with Ionic Native|[Ionic 3](http://blog.ionic.io/10-minutes-with-ionic-2-using-the-camera-with-ionic-native/)||
|Add Barcode Scanning Functionality To Your Ionic 2 App|[Ionic 3](https://www.thepolyglotdeveloper.com/2016/02/add-barcode-scanning-functionality-to-your-ionic-2-app/)||
|Adding Background Geolocation to an Ionic 2 Application|[Ionic 3](http://www.joshmorony.com/adding-background-geolocation-to-an-ionic-2-application/)||
|Custom URL scheme|[Ionic 3](https://github.com/EddyVerbruggen/Custom-URL-scheme)||
|Determine Network Availability|[Ionic 3](https://www.thepolyglotdeveloper.com/2016/01/determine-network-availability-in-an-ionic-2-mobile-app/)||
|Getting Familiar with Local Notifications in Ionic 2|[Ionic 3](http://www.joshmorony.com/getting-familiar-with-local-notifications-in-ionic-2/)||
|Having Fun With Cordova Geolocation Plugin|[Ionic 3](http://www.gajotres.net/ionic-2-having-fun-with-cordova-geolocation-plugin/)||
|How to Use Google Maps & Geolocation |[Ionic 3](http://www.joshmorony.com/ionic-2-how-to-use-google-maps-geolocation-video-tutorial/)||
|How To Use PouchDB + SQLite For Local Storage In Ionic 2|[Ionic 3](http://gonehybrid.com/how-to-use-pouchdb-sqlite-for-local-storage-in-ionic-2/)||
|How to Work With Cordova Plugins|[Ionic 3](http://www.gajotres.net/ionic-2-how-to-use-cordova-plugins/)||
|Launch Websites With Ionic 2 Using The InAppBrowser|[Ionic 3](https://www.thepolyglotdeveloper.com/2016/01/launch-websites-with-ionic-2-using-the-inappbrowser/)||
|Monetize With Google Admob In An Ionic 2 Mobile App|[Ionic 3](https://www.thepolyglotdeveloper.com/2016/02/monetize-google-admob-ionic-2-mobile-app/)||
|Share Things On Social Media Via An Ionic 2 Mobile App|[Ionic 3](https://www.thepolyglotdeveloper.com/2016/02/share-things-on-social-media-via-an-ionic-2-mobile-app/)||
|Show Native Toast Notifications In An Ionic 2 Mobile App|[Ionic 3](https://www.thepolyglotdeveloper.com/2016/01/show-native-toast-notifications-in-an-ionic-2-mobile-app/)||
|Universal URL / Deep linking|[Ionic 3](https://github.com/nordnet/cordova-universal-links-plugin)||
...
|Material design|[Ionic 3](https://material.angularjs.org/)||
|Angular Material codepen example|[Ionic 3](http://codepen.io/itamarCohen/pen/gbgxaJ)||
|autoListDivider|[Ionic 3](https://github.com/andrewmcgivery/ionic-ion-autoListDivider)|Automatically adding in list dividers for an ng-repeat.||
|Tinder style swipe Cards|[Ionic 3](http://devdactic.com/optimize-tinder-cards/)||
|Move.js CSS3 Animation framework|[Ionic 3](https://github.com/visionmedia/move.js)||
|Ionic Tabbed Slidebox|[Ionic 3](https://github.com/saravmajestic/ionic/tree/master/tabbedSlideBox)||
|Ionic directive for a location dropdown that utilizes google maps|[Ionic 3](https://github.com/israelidanny/ion-google-place)||
